    ...
    return (
        <div className="relative flex items-center justify-center h-screen bg-gray-900 text-white">
            ...
            <div className="relative z-10 text-center px-4">
                ...
                <div className="flex flex-col md:flex-row flex-wrap mt-8 space-x-0 space-y-4 md:space-y-0 md:space-x-5">
                    <a href='/non-surgical-hair-replacement' className="flex-1">
                        <button className="w-full px-6 md:px-8 py-2 md:py-3 bg-[#323232] text-white font-bold rounded-md text-sm md:text-base hover:bg-[#434141]">
                            Learn More
                        </button>
                    </a>
